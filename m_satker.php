                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $c['nilai_akhir']; ?></td>
                        <td>

                          <a href="e_satker.php?id_paket=<?php echo $c['id_paket']; ?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;

                          <a href="javascript:if(confirm('Yakin ingin menghapus data?'))
                      {document.location='d_satker.php?id_paket=<?php echo $c['id_paket']; ?>';}">
