          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              <div class="box-header">
                <a class="btn btn-success" href="a_nilai.php">Tambah Data</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    ?>
                    <?php
                    $a = "select * from nilai order by id_nilai";
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $c['jml_nilai']; ?></td>
                        <td><?php echo $c['ket']; ?></td>
                        <td>
                        
                          <a href="e_nilai.php?id_nilai=<?php echo $c['id_nilai']; ?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;

                          <a href="javascript:if(confirm('Yakin ingin menghapus data?'))
                      {document.location='d_nilai.php?id_nilai=<?php echo $c['id_nilai']; ?>';}">
