              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php
                    $periode = date('Y');
                    $a = "SELECT a.id_paket, a.nm_paket, CASE
                  WHEN a.id_paket not in (select id_paket from analisa_alternatif where periode='$periode') THEN 'Belum dihitung'
                  ELSE 'Sudah dihitung'
                  End as ket
                  from paket a
                  order by a.id_paket";
                    ...
                    ?>
                      <tr>
                        <td><?php echo $no; ?></td>
                        <td><?php echo $c['id_paket']; ?></td>
                        <td><?php echo $c['nm_paket']; ?></td>
                        <td><?php echo $c['ket']; ?></td>
                        <td>
                          <a href="analisa_nilai_alternatif.php?id_paket=<?php echo $c['id_paket']; ?>"><i class="glyphicon glyphicon-arrow-right"></i></a>&nbsp;&nbsp;
                        </td>
                      </tr>
                    <?php $no++;
                    } ?>
                ...
                <a class="btn btn-success" href="analisa_alternatif_tabel.php">Proses Data</a>
              </div>
              <!-- /.box-body -->
            </div>
            <!-- /.box -->
