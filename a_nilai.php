...
alert('Data belum lengkap !');
    ...
    $a="insert into nilai values('$id_nilai','$jml_nilai','$ket','$definisi')";
            ...
            <form role="form" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="id_nilai" class="form-control" value="<?=autonumber("nilai","id_nilai",2,"NL")?>" readonly>
                  </div>
                </div>
                <br><br>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="jml_nilai" class="form-control" placeholder="Jumlah Nilai">
                  </div>
                </div>
                <br><br>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <textarea class="form-control" rows="3" placeholder="Definisi" name="definisi"></textarea>
                  </div>
                </div>
                <div class="form-group">
