...
if (isset($_POST['simpan'])) {
  ...
  if (empty($nm_paket) or empty($deskripsi)) {
    echo "<script language='javascript'>
alert('Data belum lengkap !');
</script>";
  } else {
    $a = "update paket set nm_paket='$nm_paket', deskripsi='$deskripsi', img='$img' where id_paket='$id_paket'";
    $b = mysqli_query($koneksi, $a);
    if ($b) {
      echo "<script language='javascript'>
        alert('Data Satuan Kerja berhasil diubah');
          ...
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">Ubah Data Unit Pengolah</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form role="form" method="post">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="id_paket" class="form-control" placeholder="Kode Unit Pengolah" value="<?php echo $data['id_paket']; ?>" readonly>
                    </div>
                  </div>
                  <br><br>
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="nm_paket" class="form-control" placeholder="Unit Pengolah" value="<?php echo $data['nm_paket']; ?>">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="img" class="form-control" placeholder="Unit Pengolah" value="<?php echo $data['img']; ?>">
                    </div>
                       <br><br>
                  </div>
                  <br><br>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      &nbsp;
                     <a href="m_satker.php"> <button type="reset" class="btn btn-danger">&nbsp;&nbsp;Batal&nbsp;&nbsp;</button> </a>
                    </div>
                  </div>
                </div>
                <!-- /.box-body -->
