...
if (isset($_POST['simpan'])) {
  ...
  if ($img != "") {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
      ...
      $a = "insert into paket values('$id_paket','$nm_paket','$riasan','$riasan','$jns_rias','$jml_orang','$jml_orang','$jml_pakaian','$jml_pakaian','$anggaran','$deskripsi',' ','$nama_gambar_baru','$url')";
    ...
    $a = "insert into paket values('$id_paket','$nm_paket','$jns_rias','$riasan','$jns_rias','$jml_orang','$jml_orang','$jml_pakaian','$jml_pakaian','$anggaran','$deskripsi','','$nama_gambar_baru','')";
    $b = mysqli_query($koneksi, $a);
    if ($b) {
      echo "<script>alert('Alternatif berhasil ditambah.');window.location='m_satker.php';</script>";
    }
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Data Master
          <small>Unit Pengolah</small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
          <li><a href="#">Data Master</a></li>
          <li class="active">Unit Pengolah</li>
        </ol>
      </section>
          ...
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">Tambah Data Paket Rias</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form role="form" method="post" enctype="multipart/form-data">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="id_paket" class="form-control" placeholder="Kode Unit Pengolah" value="<?= autonumber("paket", "id_paket", 2, "PKT") ?>" readonly>
                    </div>
                  </div>
                  <br><br>
                  <div class="form-group">
                    <label for="inputnama" class="col-sm-2 control-label">Nama Paket</label>
                    <div class="col-sm-4">
                      <input type="text" name="nm_paket" class="form-control" placeholder="Nama Paket">
                    </div>
                  </div>
                  <br><br>
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <select name="riasan" id="riasan" class="form-control" required>
                        <option selected disabled>Pilih Jenis Riasan</option>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="number" name="jml_orang" class="form-control" placeholder="Jumlah Orang">
                    </div>
                  </div>
                  <br><br>
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="number" name="jml_pakaian" class="form-control" placeholder="Jumlah Pakaian Perorang">
                    </div>
                  </div>
                  <br><br>
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="number" name="anggaran" class="form-control" placeholder="Anggaran">
                    </div>
                  </div>
                  <br><br>
                  ...
                  <br><br><br><br>
                  <div class="form-group">
                    <label for="inputFoto" class="col-sm-2 control-label">Foto Paket</label>
                    <div class="col-sm-4">
                      <input type="file" name="img" class="form-control" placeholder="Foto Paket">
