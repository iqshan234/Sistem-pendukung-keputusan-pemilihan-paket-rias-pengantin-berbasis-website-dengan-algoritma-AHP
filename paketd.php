...
<div class="wrapper">
 ...
 <a href="home.php" class="logo">
  ...
  <aside class="main-sidebar">
    ...
    <!-- sidebar menu: : style can be found in sidebar.less -->
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Paket Rias D</li>
        </ol>
      </section>
   ...
   <section class="content">
    ...
    <font size="5">   Paket Rias Pengantin D

   <br>
 <div class = "media">

                       <div class = "media-body">
                             <font size="5">Paket Rias D Untuk Riasan terdiri dari : <br>
                            <div class="info-meta">
                     <li> Rias Pengantin Akad Daerah Sunda Dan Resepsi Nasional Untuk Pengantin Wanita Dan Pria: Masing-Masing 2 Pasang, </li>   
                      <li>  MakeUp Dan Baju Untuk Masing-Masing Orang Tua 2 Pasang </li>
                            <li>Busana Dan Accessories Lengkap </li>
                            <font size="5">Dan Untuk Harga Dikenakan Biaya: 5 Jutaan, Harga Masi Boleh Nego, Jika Berminat Bisa Hubungi: " +62 816-1913-978 " Atau Bisa Klik Logo Whastaspp Pada Pojok Kanan, Berikut Contoh Foto Riasan<br>
                           </font>

                            </div>
                         <a href="p4.jpg">
    <img src="p4.jpg" height="500" width="380"/>      
    <a href="a1.jpg">
    <img src="a1.jpg" height="500" width="380"/> 
     <a href="a2.jpg">
    <img src="a2.jpg" height="500" width="380"/> 
         <a href="a3.jpg">
    <img src="a3.jpg" height="500" width="380"/> 
     <a href="a4.jpg"><br><br>
    <img src="a4.jpg" height="500" width="380"/>
     <a href="a5.jpg">
    <img src="a5.jpg" height="500" width="380"/>
        <a href="a6.jpg">
    <img src="a6.jpg" height="500" width="380"/>
            <a href="i4.jpg">
    <img src="i4.jpg" height="500" width="380"/>
             <br><br>
 ...
 <a href="https://api.whatsapp.com/send?phone=628161913978&text=Halo%20saya%20ingin%20oder%20paket%20riasan D" target="_blank">                
