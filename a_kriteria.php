...
alert('Data belum lengkap !');
    ...
    $a="insert into kriteria values('$id_kriteria','$nm_kriteria','$jns_kriteria','0')";
            ...
            <form role="form" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="radio" name="jns_kriteria" id="optionsRadios2" value="Cost">
                      Cost &nbsp;
                    <input type="radio" name="jns_kriteria" id="optionsRadios2" value="Benefit">
                      Benefit
                  </div>
                </div>
                <div class="form-group">
