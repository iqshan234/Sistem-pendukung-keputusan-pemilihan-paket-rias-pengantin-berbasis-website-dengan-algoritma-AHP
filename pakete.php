...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <!-- sidebar menu: : style can be found in sidebar.less -->
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Paket Rias E</li>
        </ol>
      </section>
   ...
   <section class="content">
    ...
    <font size="5">   Paket Rias Pengantin E
   <br>
 <div class = "media">

                       <div class = "media-body">
                             <font size="5">Paket Rias E Untuk Riasan terdiri dari : <br>
                            <div class="info-meta">
                      <li>Rias Pengantin Akad Daerah Jawa Dan Resepsi Nasional Untuk Pengantin Wanita Dan Pria: Masing-Masing 3 Pasang</li>   
                      <li>  Rias Pendamping (Orang Tua) 2 Pasang</li>
                            <li>Rias Untuk Pager Ayu: 4 Orang,  </li>
                            <li> Rias Bagus Atau Among Tamu: 6 Pasang</li>
                            <li> Busana Dan Accessories Lengkap</li>
                            <li> Acara Adat Jawa 1 Paket, Terdiri Dari (Kirab, Lempar Siri, Cucur Kucur Dan Cucuk Lampah ) </li>
                            <font size="5">Dan Untuk Harga Dikenakan Biaya: 18 Jutaan, Harga Masi Boleh Nego, Jika Berminat Bisa Hubungi: " +62 816-1913-978 " Atau Bisa Klik Logo Whastaspp Pada Pojok Kanan, Berikut Contoh Foto Riasan<br>
                           </font>

                            </div>
           <a href="paket51.jpg">
    <img src="paket51.jpg" height="500" width="380"/> 
        <a href="i5.jpg">
    <img src="i5.jpg" height="500" width="380"/> 
       <img src="e1.jpg" height="500" width="380"/> 
     <a href="e2.jpg">
         <a href="a3.jpg">
    <img src="e3.jpg" height="500" width="380"/> 
     <a href="e4.jpg"><br><br>
    <img src="e4.jpg" height="500" width="380"/>
     <a href="e5.jpg">
    <img src="e5.jpg" height="500" width="380"/>
        <a href="e6.png">
    <img src="e6.png" height="500" width="380"/>
     <a href="e2.jpg">
    <img src="e2.jpg" height="500" width="380"/> 
       <br><br>
 ...
 <a href="https://api.whatsapp.com/send?phone=628161913978&text=Halo%20saya%20ingin%20oder%20paket%20riasan E" target="_blank">                
