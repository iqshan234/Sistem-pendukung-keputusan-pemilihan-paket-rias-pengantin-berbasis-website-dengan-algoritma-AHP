...
$jml_nilai=$_POST['jml_nilai'];
$ket=$_POST['ket'];
$definisi=$_POST['definisi'];
    if (empty($jml_nilai) or empty($ket) or empty($definisi)){
      echo "<script language='javascript'>
alert('Data belum lengkap !');
</script>";
    }else{
    $a="update nilai set jml_nilai='$jml_nilai', ket='$ket', definisi='$definisi' where id_nilai='$id_nilai'";
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Ubah Data Nilai</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Id Nilai</label>

                  <div class="col-sm-4">
                    <input type="text" name="id_nilai" class="form-control" placeholder="Id Nilai" value="<?php echo $data['id_nilai'];?>" readonly>
                  </div>
                </div>
                <br><br>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Jumlah Nilai</label>

                  <div class="col-sm-4">
                    <input type="text" name="jml_nilai" class="form-control" placeholder="Jumlah Nilai" value="<?php echo $data['jml_nilai'];?>">
                  </div>
                </div>
                <br><br>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="ket" class="form-control" placeholder="Keterangan" value="<?php echo $data['ket'];?>">
                  </div>
                </div>
                <br><br>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Definisi</label>

                  <div class="col-sm-4">
                    <textarea class="form-control" rows="3" placeholder="Definisi" name="definisi"><?php echo $data['definisi'];?></textarea>
                  </div>
                </div>
                <div class="form-group">
