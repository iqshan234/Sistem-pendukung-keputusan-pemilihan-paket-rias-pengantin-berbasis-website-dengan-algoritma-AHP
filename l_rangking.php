        ...
        <div class="col-xs-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Cetak Laporan Data Analisa Pebandingan Paket Rias</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="lap_data.php">
              <div class="box-body">
              ...
              <select class="form-control" name="periode" required>
                        ...
                        <option value="2022">Terakhir Perbandingan</option>
              </select>
